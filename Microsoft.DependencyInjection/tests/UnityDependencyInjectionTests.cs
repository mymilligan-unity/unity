...
namespace Unity.Microsoft.DependencyInjection.Specification.Tests
{
    public class Tests : DependencyInjectionSpecificationTests
    {
        ...
        {
            var provider = ServiceProvider.ConfigureServices(serviceCollection) as ServiceProvider;
            UnityContainer container = (UnityContainer)provider;
            container
                .EnableDiagnostic()
                .AddNewExtension<OptionsExtension>();
            return provider;
        }
