...
namespace Unity.Specification.Diagnostic.Property.Validation
{
    public abstract partial class SpecificationTests
    {
        ...
        {
            // Act
            Assert.Throws<ResolutionFailedException>(() => Container.Resolve<DependencyAttributeIndexType>());
        }
        ...
        {
            // Act
            Assert.Throws<ResolutionFailedException>(() => Container.Resolve<OptionalDependencyAttributeIndexType>());
        }
