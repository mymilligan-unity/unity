...
namespace Unity.Specification.Parameter.Attribute
{
    ...
    public class Service
    {
        ...
        public void NamedDependencyAttribute([Dependency(TestFixtureBase.Name)]string value)
        {
            Value = value;
            Called = 3;
        }
        ...
        public void OptionalNamedDependencyAttribute([OptionalDependency(TestFixtureBase.Name)]string value)
        {
            Value = value;
            Called = 5;
        }
        ...
        public void OptionalNamedDependencyAttributeMissing([OptionalDependency(TestFixtureBase.Name)]IDisposable value)
        {
            Value = value;
            Called = 7;
        }
        ...
        public void NamedDependencyAttributeWithDefaultInt([Dependency(TestFixtureBase.Name)]int value = DefaultInt)
        {
            Value = value;
            Called = 11;
        }
        ...
        public void OptionalNamedDependencyAttributeWithDefaultInt([OptionalDependency(TestFixtureBase.Name)]int value = DefaultInt)
        {
            Value = value;
            Called = 13;
        }
